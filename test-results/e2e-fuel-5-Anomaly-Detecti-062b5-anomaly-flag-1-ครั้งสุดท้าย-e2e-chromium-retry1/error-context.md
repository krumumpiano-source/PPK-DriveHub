...
- Name: e2e\fuel.spec.mjs >> 5. Anomaly Detection — ตรวจจับความผิดปกติ >> เติมน้ำมัน 3 ครั้งในวันเดียว (รถเดิม) → anomaly_flag = 1 ครั้งสุดท้าย
- Location: tests\e2e\fuel.spec.mjs:495:3
