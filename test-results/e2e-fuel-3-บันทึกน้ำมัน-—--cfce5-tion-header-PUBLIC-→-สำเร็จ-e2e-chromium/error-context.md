...
- Name: e2e\fuel.spec.mjs >> 3. บันทึกน้ำมัน — บริบทพนักงานขับรถ (QR, ไม่มี token) >> ไม่ต้องมี Authorization header (PUBLIC) → สำเร็จ
- Location: tests\e2e\fuel.spec.mjs:316:3
