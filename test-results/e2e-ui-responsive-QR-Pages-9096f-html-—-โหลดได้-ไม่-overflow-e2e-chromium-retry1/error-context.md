...
- Name: e2e\ui-responsive.spec.mjs >> QR Pages บน Mobile >> /qr-usage-record.html — โหลดได้, ไม่ overflow
- Location: tests\e2e\ui-responsive.spec.mjs:179:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8788/qr-usage-record.html
Call log:
  - navigating to "http://localhost:8788/qr-usage-record.html", waiting until "load"
