...
- Name: e2e\ui-mobile-flows.spec.mjs >> C2: QR Pages — Mobile Access >> qr-scan.html โหลดได้โดยไม่ต้อง login
- Location: tests\e2e\ui-mobile-flows.spec.mjs:105:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8788/qr-scan.html
Call log:
  - navigating to "http://localhost:8788/qr-scan.html", waiting until "load"
