...
- Name: e2e\queue.spec.mjs >> 1. Authentication — เข้าสู่ระบบ >> GET /api/auth/me — ดูข้อมูลตัวเองได้
- Location: tests\e2e\queue.spec.mjs:285:3
...
> 289 |     expect(r?.data?.role).toBe('vehicle');
  ...
  383 |       backup_driver_id: ctx.backupDriverId || null,
  384 |       mission: 'ทดสอบสร้างคิวเต็มรูปแบบ',
  385 |       destination: 'โรงเรียนพะเยาพิทยาคม',
  386 |       passengers: '5 คน',
  387 |       requested_by: 'ผู้ทดสอบ',
  388 |       notes: 'หมายเหตุทดสอบ',
  389 |     }, ctx.queueToken);
```