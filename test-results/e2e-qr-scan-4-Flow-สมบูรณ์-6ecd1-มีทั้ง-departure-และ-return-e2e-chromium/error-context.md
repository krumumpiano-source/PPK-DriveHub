...
- Name: e2e\qr-scan.spec.mjs >> 4. Flow สมบูรณ์ — บันทึกออกและกลับ >> ดู usage records ผ่าน admin → มีทั้ง departure และ return
- Location: tests\e2e\qr-scan.spec.mjs:374:3
