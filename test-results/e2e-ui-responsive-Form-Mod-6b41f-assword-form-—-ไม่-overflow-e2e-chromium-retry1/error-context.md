...
- Name: e2e\ui-responsive.spec.mjs >> Form & Modal บน Mobile >> forgot-password form — ไม่ overflow
- Location: tests\e2e\ui-responsive.spec.mjs:157:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8788/forgot-password.html
Call log:
  - navigating to "http://localhost:8788/forgot-password.html", waiting until "load"
