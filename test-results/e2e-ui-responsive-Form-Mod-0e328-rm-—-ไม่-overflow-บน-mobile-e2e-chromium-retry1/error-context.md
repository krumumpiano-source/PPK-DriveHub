...
- Name: e2e\ui-responsive.spec.mjs >> Form & Modal บน Mobile >> Register form — ไม่ overflow บน mobile
- Location: tests\e2e\ui-responsive.spec.mjs:149:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8788/register.html
Call log:
  - navigating to "http://localhost:8788/register.html", waiting until "load"
