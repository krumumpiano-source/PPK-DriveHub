...
- Name: e2e\ui-responsive.spec.mjs >> QR Pages บน Mobile >> /qr-daily-check.html — โหลดได้, ไม่ overflow
- Location: tests\e2e\ui-responsive.spec.mjs:179:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8788/qr-daily-check.html
Call log:
