...
- Name: e2e\qr-scan.spec.mjs >> 5. Flow ลืมบันทึกกลับ — Auto-Heal Return >> มี record ทั้งหมด 3 รายการ (dep1, auto_return, dep2)
- Location: tests\e2e\qr-scan.spec.mjs:473:3
