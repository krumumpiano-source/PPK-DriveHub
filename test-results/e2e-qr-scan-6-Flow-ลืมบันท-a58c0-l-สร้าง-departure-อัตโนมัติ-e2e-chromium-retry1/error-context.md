...
- Name: e2e\qr-scan.spec.mjs >> 6. Flow ลืมบันทึกออก — Auto-Heal Departure >> บันทึกกลับครั้งที่ 2 (ลืมบันทึกออก) → auto-heal สร้าง departure อัตโนมัติ
- Location: tests\e2e\qr-scan.spec.mjs:520:3
