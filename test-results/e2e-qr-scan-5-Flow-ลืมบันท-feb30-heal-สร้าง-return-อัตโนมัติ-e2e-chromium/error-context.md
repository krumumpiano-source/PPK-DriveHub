...
- Name: e2e\qr-scan.spec.mjs >> 5. Flow ลืมบันทึกกลับ — Auto-Heal Return >> บันทึกออกครั้งที่ 2 (ลืมบันทึกกลับ) → auto-heal สร้าง return อัตโนมัติ
- Location: tests\e2e\qr-scan.spec.mjs:444:3
