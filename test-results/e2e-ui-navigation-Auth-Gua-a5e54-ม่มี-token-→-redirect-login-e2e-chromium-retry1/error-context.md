...
- Name: e2e\ui-navigation.spec.mjs >> Auth Guard >> /vehicles.html ไม่มี token → redirect login
- Location: tests\e2e\ui-navigation.spec.mjs:261:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8788/vehicles.html
Call log:
  - navigating to "http://localhost:8788/vehicles.html", waiting until "load"
