...
- Name: e2e\app.spec.mjs >> หน้า Vehicle Timeline >> โหลดหน้า Vehicle Timeline สำเร็จ
- Location: tests\e2e\app.spec.mjs:546:3
...
Call log:
  - navigating to "http://localhost:8788/vehicle-timeline.html", waiting until "load"
