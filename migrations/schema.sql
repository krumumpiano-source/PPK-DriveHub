...
CREATE TABLE IF NOT EXISTS vehicle_requests (
  ...
  status TEXT NOT NULL DEFAULT 'pending_supervisor' CHECK(status IN ('pending','pending_supervisor','pending_executive','approved','rejected','cancelled')),
  supervisor_id TEXT,
...
-- Added from 006-add-missing-indexes.sql
-- 1. queue table
