...
INSERT OR IGNORE INTO repair_log (
  ...
  'เปลี่ยนน้ำมันเครื่อง, ล้างหัวฉีด, ล้างเครื่องยนต์, ล้างตู้แอร์', 'scheduled_maintenance',
  'โตโยต้าพะเยา (1994)',
  53714, 53714, NULL,
...
INSERT OR IGNORE INTO repair_log (
  ...
  'ล้างหัวฉีด, ล้างเครื่องยนต์, ล้างตู้แอร์', 'scheduled_maintenance',
  'โตโยต้าพะเยา (1994)',
  62884, 62884, NULL,
...
INSERT OR IGNORE INTO repair_log (
  ...
  'เปลี่ยนน้ำมันเกียร์, เปลี่ยนน้ำมันเบรก-คลัทช์, สลับยาง', 'scheduled_maintenance',
  'โตโยต้าพะเยา (1994)',
  80558, 80558, NULL,
...
VALUES ('ri-3816-002-01', 'rep-3816-002', 'A-08880-83932', 'น้ำมันเครื่องดีเซลสังเคราะห์ L', 2, 256.00, 0.00, 512.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-002-02', 'rep-3816-002', 'A-08880-83933', 'น้ำมันเครื่องดีเซลสังเคราะห์ G', 1, 1475.00, 0.00, 1475.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-002-03', 'rep-3816-002', 'A-90080-43030', 'ประเก็นน็อตถ่ายน้ำมันเครื่อง', 1, 20.00, 0.00, 20.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-002-04', 'rep-3816-002', 'A-90915-YZZD2', 'กรองน้ำมันเครื่อง', 1, 205.00, 0.00, 205.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-002-05', 'rep-3816-002', 'B-PZT00', 'น้ำยาล้างเบรก', 2, 30.00, 0.00, 60.00, 'part');

-- === Record 3: 20,000 km (rep-3816-003) ===
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-003-01', 'rep-3816-003', 'A-08808-80230', 'น้ำยาทำความสะอาดกระจก', 1, 140.00, 0.00, 140.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-003-02', 'rep-3816-003', 'A-08813-80029', 'น้ำยาล้างหัวฉีดดีเซล', 1, 374.00, 0.00, 374.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-003-03', 'rep-3816-003', 'A-08814-80170', 'น้ำยาล้างเครื่องยนต์ดีเซล', 1, 530.00, 0.00, 530.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-003-04', 'rep-3816-003', 'A-08821-80870', 'ผลิตภัณฑ์ล้างคอยล์เย็น', 1, 1601.00, 0.00, 1601.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-003-05', 'rep-3816-003', '420018', 'สลับยางและถ่วงล้อ', 1, 156.00, 0.00, 156.00, 'labour');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-003-06', 'rep-3816-003', 'AIRCARE', 'ทำความสะอาดตู้แอร์', 1, 200.00, 0.00, 200.00, 'labour');

-- === Record 4: 50,000 km (rep-3816-004) ===
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-004-01', 'rep-3816-004', 'A-08813-80029', 'น้ำยาล้างหัวฉีดดีเซล', 1, 375.00, 0.00, 375.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-004-02', 'rep-3816-004', 'A-08814-80170', 'น้ำยาล้างเครื่องยนต์ดีเซล', 1, 532.00, 0.00, 532.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-004-03', 'rep-3816-004', 'A-08821-80870', 'ผลิตภัณฑ์ล้างคอยล์เย็น', 1, 1602.00, 0.00, 1602.00, 'part');

-- === Record 5: 60,000 km (rep-3816-005) ===
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-005-01', 'rep-3816-005', '60000', 'เช็คระยะ 60,000 กม.', 1, 1150.00, 0.00, 1150.00, 'service');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-005-02', 'rep-3816-005', 'A-08813-80005', 'น้ำยาล้างหัวฉีดดีเซล', 1, 375.00, 0.00, 375.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-005-03', 'rep-3816-005', 'A-08814-80170', 'น้ำยาล้างเครื่องยนต์ดีเซล', 1, 532.00, 0.00, 532.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-005-04', 'rep-3816-005', 'A-08821-80870', 'ผลิตภัณฑ์ล้างคอยล์เย็น', 1, 1602.00, 0.00, 1602.00, 'part');

-- === Record 6: 70,000 km (rep-3816-006) ===
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-006-01', 'rep-3816-006', '14199', 'ทำความสะอาดกลไกวาล์ว', 1, 462.80, 0.00, 462.80, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-006-02', 'rep-3816-006', 'A-08814-80170', 'น้ำยาล้างเครื่องยนต์ดีเซล', 1, 532.00, 0.00, 532.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-006-03', 'rep-3816-006', 'A-08880-83933', 'น้ำมันเครื่องดีเซลสังเคราะห์ G', 1, 1535.00, 0.00, 1535.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-006-04', 'rep-3816-006', '420018', 'สลับยางและถ่วงล้อ', 1, 156.00, 0.00, 156.00, 'labour');

-- === Record 7: 80,000 km (rep-3816-007) ===
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-007-01', 'rep-3816-007', '80000', 'เช็คระยะ 80,000 กม.', 1, 1500.00, 0.00, 1500.00, 'service');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-007-02', 'rep-3816-007', 'A-08814-80170', 'น้ำยาล้างเครื่องยนต์ดีเซล', 1, 532.00, 0.00, 532.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-007-03', 'rep-3816-007', 'A-08823-80170', 'น้ำมันเบรก_คลัทช์', 2, 117.00, 0.00, 234.00, 'part');
INSERT OR IGNORE INTO repair_items (id, repair_id, part_code, description, quantity, unit_price, discount_amount, net_amount, item_type)
VALUES ('ri-3816-007-04', 'rep-3816-007', '420018', 'สลับยางและถ่วงล้อ', 1, 156.00, 0.00, 156.00, 'labour');
...
-- engine_oil: last at 71,422 km (2025-10-10) — record 6 had oil change
-- (record 7 at 80,558 had gear oil + brake fluid but no engine oil)
...
VALUES ('vm-3816-engine_oil', 'df5fd5a5-287e-4e10-a8d0-f6818daa6522', 'engine_oil', 71422, '2025-10-10', 81422, '2026-04-10', '2026-04-12T00:00:00Z')
...
-- oil_filter: last at 12,360 km (2023-11-21) — record 2 had filter change
-- every 10,000 km / 6 months
INSERT INTO vehicle_maintenance (id, car_id, item_key, last_km, last_date, next_km, next_date, updated_at)
VALUES ('vm-3816-oil_filter', 'df5fd5a5-287e-4e10-a8d0-f6818daa6522', 'oil_filter', 12360, '2023-11-21', 22360, '2024-05-21', '2026-04-12T00:00:00Z')
ON CONFLICT(car_id, item_key) DO UPDATE SET last_km=excluded.last_km, last_date=excluded.last_date, next_km=excluded.next_km, next_date=excluded.next_date, updated_at=excluded.updated_at;
