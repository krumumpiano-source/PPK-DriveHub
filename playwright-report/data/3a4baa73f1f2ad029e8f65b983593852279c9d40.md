...
- Name: e2e\check-repair.spec.mjs >> 1. Daily Check — บันทึกตรวจสภาพ (Public) >> issues_found: true → override เป็น critical + สร้าง alert
- Location: tests\e2e\check-repair.spec.mjs:207:3
