...
- Name: e2e\repair-comprehensive.spec.mjs >> 3. Edge Cases — ข้อมูลผิดปกติจากผู้ใช้ >> daily check: mileage เป็น string "abc" → success (normalize เป็น 0)
- Location: tests\e2e\repair-comprehensive.spec.mjs:362:3
