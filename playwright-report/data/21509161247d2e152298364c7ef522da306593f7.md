...
- Name: e2e\qr-scan.spec.mjs >> 6. Flow ลืมบันทึกออก — Auto-Heal Departure >> บันทึกกลับครั้งที่ 1 (ไม่มี departure ก่อน) สำเร็จ — ไม่มี auto_heal
- Location: tests\e2e\qr-scan.spec.mjs:500:3
