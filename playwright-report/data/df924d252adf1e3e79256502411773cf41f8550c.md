...
- Name: e2e\driver.spec.mjs >> 10. UI — หน้าที่พนักงานขับรถเข้าไม่ได้ (ต้องถูกจำกัด) >> จัดการผู้ใช้ (/user-management.html) — ถูก redirect หรือแสดงข้อผิดพลาด ไม่ใช่หน้าปกติ
