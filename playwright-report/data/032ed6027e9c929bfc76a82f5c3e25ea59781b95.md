...
- Name: e2e\driver.spec.mjs >> 8. ขอบเขตสิทธิ์ — Permission Boundaries (API) >> ไม่สามารถดู report/summary ได้ถ้าไม่มีสิทธิ์ (reports:view → 403)
- Location: tests\e2e\driver.spec.mjs:572:3
