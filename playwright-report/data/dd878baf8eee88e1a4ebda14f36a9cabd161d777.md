...
- Name: e2e\roles.spec.mjs >> Auth Guard — ทุกหน้าต้อง redirect ถ้าไม่มี token >> /admin-settings.html — redirect ไป login ถ้าไม่ login
- Location: tests\e2e\roles.spec.mjs:340:5
