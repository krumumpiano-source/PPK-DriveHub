...
- Name: e2e\qr-scan.spec.mjs >> 6. Flow ลืมบันทึกออก — Auto-Heal Departure >> สถานะหลัง auto-heal → in (return ล่าสุดกว่า auto_departure)
- Location: tests\e2e\qr-scan.spec.mjs:548:3
