...
- Name: e2e\fuel.spec.mjs >> 4. บันทึกน้ำมัน — บริบทคณะทำงาน (Admin/Staff, มี token) >> บันทึกน้ำมันพร้อมข้อมูลครบทุก field → สำเร็จ
- Location: tests\e2e\fuel.spec.mjs:378:3
