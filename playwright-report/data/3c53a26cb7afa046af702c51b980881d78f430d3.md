...
- Name: e2e\check-repair.spec.mjs >> 1. Daily Check — บันทึกตรวจสภาพ (Public) >> ไม่ต้องมี token (PUBLIC endpoint) → สำเร็จ
- Location: tests\e2e\check-repair.spec.mjs:172:3
