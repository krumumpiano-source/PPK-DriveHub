...
- Name: e2e\check-repair.spec.mjs >> 1. Daily Check — บันทึกตรวจสภาพ (Public) >> บันทึกตรวจสภาพพร้อมรายละเอียดครบทุก field → สำเร็จ
- Location: tests\e2e\check-repair.spec.mjs:143:3
