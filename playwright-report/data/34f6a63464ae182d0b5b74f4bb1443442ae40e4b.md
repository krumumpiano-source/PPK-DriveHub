...
- Name: e2e\check-repair.spec.mjs >> 1. Daily Check — บันทึกตรวจสภาพ (Public) >> overall_status ไม่ถูกต้อง → normalize เป็น ok
- Location: tests\e2e\check-repair.spec.mjs:223:3
