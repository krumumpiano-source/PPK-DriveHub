...
- Name: e2e\fuel.spec.mjs >> 3. บันทึกน้ำมัน — บริบทพนักงานขับรถ (QR, ไม่มี token) >> บันทึกน้ำมัน ด้วย driver_name_manual (ไม่มีในระบบ) → สำเร็จ
- Location: tests\e2e\fuel.spec.mjs:295:3
