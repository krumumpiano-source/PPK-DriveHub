...
- Name: e2e\fuel.spec.mjs >> 4. บันทึกน้ำมัน — บริบทคณะทำงาน (Admin/Staff, มี token) >> บันทึกน้ำมันด้วย expense_type: private → สำเร็จ
- Location: tests\e2e\fuel.spec.mjs:427:3
