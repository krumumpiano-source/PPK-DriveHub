...
- Name: e2e\driver.spec.mjs >> 11. UI Sidebar — เมนู Navigation ของพนักงานขับรถ >> sidebar ไม่แสดงเมนูผู้ดูแลระบบ (admin section) ให้พนักงานขับรถ
- Location: tests\e2e\driver.spec.mjs:770:3
