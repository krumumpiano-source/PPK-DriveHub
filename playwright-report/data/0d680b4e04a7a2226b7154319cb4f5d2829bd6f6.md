...
- Name: e2e\driver.spec.mjs >> 9. UI — หน้าที่พนักงานขับรถเข้าได้ >> เข้า คิวและประวัติส่วนตัว (/driver-history.html) ได้ — ไม่ redirect ไป login
- Location: tests\e2e\driver.spec.mjs:644:5
