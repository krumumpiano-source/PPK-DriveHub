...
- Name: e2e\check-repair.spec.mjs >> 1. Daily Check — บันทึกตรวจสภาพ (Public) >> บันทึกด้วย license_plate แทน UUID → สำเร็จ
- Location: tests\e2e\check-repair.spec.mjs:163:3
